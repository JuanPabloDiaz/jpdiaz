...
function transformToPhrasingContent(children: Content[]): PhrasingContent[] {
...
const remarkCollapse: Plugin<[RemarkCollapseOptions?], Node, Node> = (
	...
	const transformer = (tree: Node) => {
		visit(tree, (node: Node, index?: number, parent?: Parent) => {
			...
			const detailsNode = h('details', { class: 'remark-collapse' } as HastProperties, [
